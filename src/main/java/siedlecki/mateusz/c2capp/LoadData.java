...
public class LoadData implements CommandLineRunner {
    ...
    public void createClients(){
        ...
        Route lublinLH = new Route("Lublin LH", new ArrayList<>());
        ...
        saveClient(Client.builder().warehouseName("LH KONWALIOWA").realName("Minuta 8").nip("9462640744").address("Konwaliowa 7, 20-258 Turka").coordinates(new Coordinates("51.274476","22.666250")).info("Stajemy przy drodze. Towar nosimy do tylnego wejscia").route(new Route("Lublin LH")).build());
        saveClient(Client.builder().warehouseName("LH TURKA").realName("Top Market").nip("9462640744").address("Bukowa 2, 20-258 Turka").coordinates(new Coordinates("51.277517","22.658585")).info("Trzeba objechac budynek. Wejscie z tylu od ulicy klonowej").route(new Route("Lublin LH")).build());
        ...
        saveClient(Client.builder().warehouseName("LH KREZNICKA").realName("Sklep Top Market").address("Kreznicka 222C, 20-518 Lublin").coordinates(new Coordinates("51.165452","22.494359")).info("Rampa z lewej strony sklepu").route(new Route("Lublin LH")).build());
        saveClient(Client.builder().warehouseName("LH NOWY SWIAT").realName("Sklep Top Market").address("Nowy Swiat 37F, 20-418 Lublin").coordinates(new Coordinates("51.224771","22.561093")).info("Towar dostarczamy z tylu budynku").route(new Route("Lublin LH")).build());
        saveClient(Client.builder().warehouseName("LH GLUSK").realName("Sklep Top Market").address("Gluska 133, 20-380 Lublin").coordinates(new Coordinates("51.195613","22.594956")).info("Wjezdzajac na parking drzwi na wprost").route(new Route("Lublin LH")).build());
        ...
        saveClient(Client.builder().warehouseName("LH OKRZEI").realName("Sklep Top Market").address("Stefana Okrzei 2, 20-128 Lublin").coordinates(new Coordinates("51.256445","22.584020")).info("Wjwzdzamy do konca za garmazerka. Miedzy garmazerka a fryzjerem sa biale drzwi. Dzwonimy dzwonkiem przy tych drzwiach i idziemy do samego konca. Tam nam otworza").route(new Route("Lublin LH")).build());
        saveClient(Client.builder().warehouseName("LH TUMIDAJSKIEGO").realName("Sklep Top Market").address("Kazimierza Tumidajskiego 18A, 20-400 Lublin").coordinates(new Coordinates("51.258245","22.590646")).info("Wjazd od ul. Niepodleglosci 5. Wjazd w do konca tunelu na zaplecze w prawo").route(new Route("Lublin LH")).build());
        saveClient(Client.builder().warehouseName("LH POGODNA").realName("Sklep Top Market").address("Pogodna 42, 20-337 Lublin").coordinates(new Coordinates("51.233558","22.596546")).info("Wjazd na zaplecze od parkingu przy sklepie (tunel)").route(new Route("Lublin LH")).build());
        saveClient(Client.builder().warehouseName("LH BUKOWA").realName("Sklep Top Market").address("Bukowa 15, 20-374 Lublin").coordinates(new Coordinates("51.228832","22.582538")).info("Towar zdajemy na rampie").route(new Route("Lublin LH")).build());
        ...
        saveClient(Client.builder().warehouseName("LH KIEPURY").realName("Sklep Top Market").address("Kiepury 11A, 20-838 Lublin").coordinates(new Coordinates("51.257447","22.542945")).info("Wjezdzamy w tunel przy budynku drzwi po prawej w glebi").route(new Route("Lublin LH")).build());
        ...
        saveClient(Client.builder().warehouseName("LH RAABEGO").realName("Sklep Minuta 8").address("Rektora Henryka Raabego 2, 20-030 Lublin").coordinates(new Coordinates("51.244619","22.544676")).info("Glowne wejscie").route(new Route("Lublin LH")).build());
        saveClient(Client.builder().warehouseName("LH 1-GO MAJA").realName("Sklep Top Market").address("1 Maja 34, 20-410 Lublin").coordinates(new Coordinates("51.233017","22.569398")).info("na przeciwko glownego wejscia. przy samochodach stajemy. brama metalowa po prawej stronie i tam").route(new Route("Lublin LH")).build());
